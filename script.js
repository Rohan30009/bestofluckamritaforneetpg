...
Most ATP during aerobic metabolism is generated by:`,
    ...
    // QUESTION 52
    {
        question: `Dr Satpal notices that Rohan's pulse rises from 60/min to 104/min immediately after being asked:

“So, what exactly are your intentions regarding my daughter?”

Rohan remains conscious but suddenly loses approximately 80% of his vocabulary. After a brief period of profound sympathetic overactivity, he regains his composure and earnestly tells Dr Satpal that he adores and cherishes Amrita, wishes for her company, and to see life together with her, be with her in good health and sickness.


Which physiological mechanism most directly produces his tachycardia?`,

        answers: [
            "A. M₂ stimulation of the SA node",
            "B. β₁-adrenergic stimulation of the SA node",
            "C. α₂ stimulation of the AV node",
            "D. Increased vagal tone",
            "E. Acute father-of-girlfriend syndrome"
        ],

        correct: [1],

        correctMessage:
            "β₁-adrenergic stimulation of the SA node increases heart rate. The accompanying 80% reduction in vocabulary remains a well-documented but poorly understood response to paternal questioning."
    }
